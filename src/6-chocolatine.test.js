...
expect(chocolatine("pain au chocolat, pain au chocolat, et encore pain au chocolat !")).toBe("chocolatine, chocolatine, et encore chocolatine !");
});
...
expect(chocolatine("Quand je vais à la boulangerie, je prends toujours un pain au chocolat avant d'aller en cours.")).toBe("Quand je vais à la boulangerie, je prends toujours une chocolatine avant d'aller en cours.");
});